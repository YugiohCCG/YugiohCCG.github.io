...
function s.spcon(e,tp,eg,ep,ev,re)
	return ev>=2 or re:GetHandler():IsSetCard(SET_SCARSTECH)
end
...
function s.thfilter(c) return c:IsSetCard(SET_SCARSTECH) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand() end
