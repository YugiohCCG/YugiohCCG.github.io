...
function s.handcon(e)
	...
	return Duel.GetCurrentChain()==0 and ac and ac:IsControler(1-tp)
		and Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0 and Duel.GetFieldGroupCount(tp,0,LOCATION_MZONE)>0
end
...
function s.negcon(e,tp,eg,ep,ev,re,r,rp) return not e:GetHandler():IsLocation(LOCATION_HAND) and Duel.IsBattlePhase() and rp==1-tp and Duel.IsChainNegatable(ev) end
