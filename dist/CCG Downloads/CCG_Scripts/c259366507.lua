--Aquila, Zephorion's Predictor
local s,id=GetID()
local STRING_ID=133366507
...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	local b1=Duel.IsExistingMatchingCard(aux.NecroValleyFilter(s.listfilter),tp,LOCATION_GRAVE,0,1,nil)
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if op==0 then
		...
		local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.listfilter),tp,LOCATION_GRAVE,0,1,1,nil)
		if #g>0 then
