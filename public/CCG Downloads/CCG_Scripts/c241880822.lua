...
function s.thfilter(c)
	return c:IsSetCard(0x6f6) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function s.spfilter2(c,e,tp)
	return c:IsSetCard(0x6f6) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
