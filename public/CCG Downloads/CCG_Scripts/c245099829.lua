--Azrynior, the Abundaence of Purity
local s,id=GetID()
...
function s.initial_effect(c)
	...
	c:RegisterEffect(e5)
	--If a Protogenic Essence Token was Tributed this turn
...
function s.tkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,TOKEN_PROTOGENIC,SET_TO_PROTO,TYPES_TOKEN_MONSTER,0,0,1,RACE_GALAXY,ATTRIBUTE_LIGHT) then return end
