...
public class NekrozExecutor : DefaultExecutor
{
	...
	private sealed class <>c
	{
		...
		[CallerCount(Count = 0)]
		[Calls(Type = typeof(NekrozExecutor), Member = ".ctor", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(GameAI), typeof(BotDuel)}, ReturnType = typeof(void))]
	...
	{
		public const int DancePrincess = 52738610; //Field offset: 0x0
		public const int RoyalDecree = 51452091; //Field offset: 0x0
		public const int MysticalSpaceTyphoon = 5318639; //Field offset: 0x0
		public const int Cycle = 97211663; //Field offset: 0x0
		public const int Kaleidoscope = 51124303; //Field offset: 0x0
		public const int Mirror = 14735698; //Field offset: 0x0
		...
		public const int PhantomOfChaos = 30312361; //Field offset: 0x0
		public const int Clausolas = 99185129; //Field offset: 0x0
		public const int Unicore = 89463537; //Field offset: 0x0
		public const int Brionac = 26674724; //Field offset: 0x0
		public const int Gungnir = 74122412; //Field offset: 0x0
		public const int Valkyrus = 25857246; //Field offset: 0x0
		public const int Trishula = 52068432; //Field offset: 0x0
		public const int DecisiveArmor = 88240999; //Field offset: 0x0
		public const int MaxxC = 23434538; //Field offset: 0x0
		public const int Shurit = 90307777; //Field offset: 0x0
		public const int TenThousandHands = 95492061; //Field offset: 0x0
		public const int ThousandHands = 23401839; //Field offset: 0x0
	...
	private readonly List<Int32> NekrozRituelCard; //Field offset: 0x78
	private readonly List<Int32> NekrozSpellCard; //Field offset: 0x80
	...
	public NekrozExecutor(GameAI ai, BotDuel duel) { }
	...
	[Calls(Type = typeof(GameAI), Member = "SelectCard", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(int)}, ReturnType = typeof(void))]
	[Calls(Type = typeof(BotClientField), Member = "HasInGraveyard", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(int)}, ReturnType = typeof(bool))]
	[Calls(Type = typeof(NekrozExecutor), Member = "IsTheLastPossibility", ReturnType = typeof(bool))]
