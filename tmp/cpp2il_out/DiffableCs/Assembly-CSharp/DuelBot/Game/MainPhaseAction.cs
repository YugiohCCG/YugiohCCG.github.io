...
{
	[CompilerGenerated]
	private MainAction <Action>k__BackingField; //Field offset: 0x10
	[CompilerGenerated]
	private int <Index>k__BackingField; //Field offset: 0x14

	public private MainAction Action
	{
	...
	[DeduplicatedMethod]
	public MainPhaseAction(MainAction action, Int32[] indexes) { }

	[CallerCount(Count = 94)]
	[CompilerGenerated]
	[DeduplicatedMethod]
	public MainAction get_Action() { }
	...
	[CompilerGenerated]
	[DeduplicatedMethod]
	private void set_Action(MainAction value) { }
