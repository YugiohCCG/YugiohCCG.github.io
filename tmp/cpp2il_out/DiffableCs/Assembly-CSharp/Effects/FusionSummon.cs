...
public class FusionSummon : MonoBehaviour
{
	[CompilerGenerated]
	private struct <SetMaterials>d__2 : IAsyncStateMachine
	{
		public int <>1__state; //Field offset: 0x0
		public AsyncVoidMethodBuilder <>t__builder; //Field offset: 0x8
		public int mats; //Field offset: 0x28
		public FusionSummon <>4__this; //Field offset: 0x30
	...
	[CompilerGenerated]
	private bool <SetMaterials>b__2_0() { }
	...
	[CallsUnknownMethods(Count = 1)]
	public static void SetMaterials(FusionSummon target, object callback) { }

	[AsyncStateMachine(typeof(<SetMaterials>d__2))]
	[CalledBy(Type = typeof(FusionSummon), Member = "SetMaterials", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(FusionSummon), typeof(object)}, ReturnType = typeof(void))]
	...
	[Calls(Type = typeof(AsyncVoidMethodBuilder), Member = "Start", MemberTypeParameters = new IL2CPP_TYPE_OBJECT[] {typeof(<SetMaterials>d__2)}, MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(<SetMaterials>d__2&)}, ReturnType = typeof(void))]
	[CallsUnknownMethods(Count = 2)]
	public void SetMaterials(int mats) { }
