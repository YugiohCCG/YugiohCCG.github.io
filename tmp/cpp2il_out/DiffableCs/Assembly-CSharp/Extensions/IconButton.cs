...
public class IconButton : AudibleObject, IPointerEnterHandler, IEventSystemHandler, IPointerClickHandler, IPointerExitHandler
{
	public Image Icon; //Field offset: 0x28
	public TextMeshProUGUI Label; //Field offset: 0x30
	private Image Button; //Field offset: 0x38
	...
	[CalledBy(Type = typeof(IconButton), Member = "OnPointerClick", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(PointerEventData)}, ReturnType = typeof(void))]
