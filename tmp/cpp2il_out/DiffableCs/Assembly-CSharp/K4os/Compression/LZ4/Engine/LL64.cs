...
internal class LL64 : LL
{
	...
	protected const int ALGORITHM_ARCH = 8; //Field offset: 0x0
	...
	[CalledBy(Type = typeof(LL64), Member = "LZ4_compress_default", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(Byte*), typeof(Byte*), typeof(int), typeof(int)}, ReturnType = typeof(int))]
	[CallerCount(Count = 2)]
	[Calls(Type = typeof(LL64), Member = "LZ4_compress_fast_extState", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_stream_t*), typeof(Byte*), typeof(Byte*), typeof(int), typeof(int), typeof(int)}, ReturnType = typeof(int))]
	...
	[CalledBy(Type = typeof(LL64), Member = "LZ4_compress_fast", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(Byte*), typeof(Byte*), typeof(int), typeof(int), typeof(int)}, ReturnType = typeof(int))]
	[CallerCount(Count = 1)]
	...
	[Calls(Type = typeof(LL64), Member = "LZ4_compress_HC_extStateHC_fastReset", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(int), typeof(int), typeof(int)}, ReturnType = typeof(int))]
	...
	[Calls(Type = typeof(LL64), Member = "LZ4HC_compress_generic_dictCtx", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(Int32*), typeof(int), typeof(int), typeof(limitedOutput_directive)}, ReturnType = typeof(int))]
	[Calls(Type = typeof(LL64), Member = "LZ4HC_compress_generic_noDictCtx", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(Int32*), typeof(int), typeof(int), typeof(limitedOutput_directive)}, ReturnType = typeof(int))]
	...
	[CalledBy(Type = typeof(LL64), Member = "LZ4_compress_HC_continue", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(int), typeof(int)}, ReturnType = typeof(int))]
	[CalledBy(Type = typeof(LL64), Member = "LZ4_compress_HC_continue_destSize", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(Int32*), typeof(int)}, ReturnType = typeof(int))]
	[CallerCount(Count = 3)]
	[Calls(Type = typeof(LL), Member = "LZ4HC_init_internal", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*)}, ReturnType = typeof(void))]
	...
	[CalledBy(Type = typeof(LL64), Member = "LZ4_decompress_safe_usingDict", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(Byte*), typeof(Byte*), typeof(int), typeof(int), typeof(Byte*), typeof(int)}, ReturnType = typeof(int))]
	[CalledBy(Type = typeof(LL64), Member = "LZ4_decompress_safe_continue", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamDecode_t*), typeof(Byte*), typeof(Byte*), typeof(int), typeof(int)}, ReturnType = typeof(int))]
	[CallerCount(Count = 4)]
	[CallsUnknownMethods(Count = 1)]
	...
	[CalledBy(Type = typeof(LL64), Member = "LZ4HC_compress_generic", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(Int32*), typeof(int), typeof(int), typeof(limitedOutput_directive)}, ReturnType = typeof(int))]
	...
	[CalledBy(Type = typeof(ValidationUtils), Member = "ArgumentNotNull", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(object), typeof(string)}, ReturnType = typeof(void))]
	[CalledBy(Type = typeof(LL64), Member = "LZ4HC_compress_hashChain", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(Int32*), typeof(int), typeof(int), typeof(limitedOutput_directive), typeof(dictCtx_directive)}, ReturnType = typeof(int))]
	[CalledBy(Type = typeof(LL64), Member = "LZ4HC_compress_optimal", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(LZ4_streamHC_t*), typeof(Byte*), typeof(Byte*), typeof(Int32*), typeof(int), typeof(int), typeof(uint), typeof(limitedOutput_directive), typeof(bool), typeof(dictCtx_directive), typeof(HCfavor_e)}, ReturnType = typeof(int))]
