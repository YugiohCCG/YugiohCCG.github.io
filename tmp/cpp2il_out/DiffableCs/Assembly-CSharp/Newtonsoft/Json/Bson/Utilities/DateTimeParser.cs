...
internal struct DateTimeParser
{
	...
	private string _text; //Field offset: 0x28
	...
	[CalledBy(Type = typeof(DateTimeParser), Member = "Parse", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(string), typeof(int), typeof(int)}, ReturnType = typeof(bool))]
	[CallerCount(Count = 1)]
