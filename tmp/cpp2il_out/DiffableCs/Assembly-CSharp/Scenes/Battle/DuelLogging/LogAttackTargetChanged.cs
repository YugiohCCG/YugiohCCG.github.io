...
public class LogAttackTargetChanged : LogEntryContent
{
	[SerializeField]
	...
	[SerializeField]
	private LogCardEntry OldTarget; //Field offset: 0x30
	[SerializeField]
	private LogCardEntry NewTarget; //Field offset: 0x38

	[CallerCount(Count = 36)]
	[CallsDeduplicatedMethods(Count = 1)]
	[DeduplicatedMethod]
	public LogAttackTargetChanged() { }
