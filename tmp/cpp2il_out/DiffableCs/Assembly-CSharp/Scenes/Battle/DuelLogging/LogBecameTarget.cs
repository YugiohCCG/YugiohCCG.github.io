...
public class LogBecameTarget : LogEntryContent
{
	[SerializeField]
	...
	[SerializeField]
	private LogCardEntry Targeter; //Field offset: 0x30
	[SerializeField]
	private LogCardEntry Target; //Field offset: 0x38
	[SerializeField]
	private Image TargetIcon; //Field offset: 0x40

	[CallerCount(Count = 36)]
	[CallsDeduplicatedMethods(Count = 1)]
	[DeduplicatedMethod]
	public LogBecameTarget() { }
