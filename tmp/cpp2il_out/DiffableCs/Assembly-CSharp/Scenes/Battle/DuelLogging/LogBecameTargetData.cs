...
public class LogBecameTargetData : ILogEventData, IPooledData
{
	[CompilerGenerated]
	...
	[CalledBy(Type = typeof(LogManager), Member = "OnBecameTarget", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(ClientCard), typeof(ClientCard)}, ReturnType = typeof(void))]
	[CallerCount(Count = 1)]
	[CallsDeduplicatedMethods(Count = 1)]
	public LogBecameTargetData() { }
