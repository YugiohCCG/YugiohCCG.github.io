...
public class LogCardHintAttribute : LogEntryContent
{
	[SerializeField]
	...
	[SerializeField]
	private Image Attribute; //Field offset: 0x30
	[SerializeField]
	private LogCardEntry Card; //Field offset: 0x38

	[CallerCount(Count = 36)]
	[CallsDeduplicatedMethods(Count = 1)]
	[DeduplicatedMethod]
	public LogCardHintAttribute() { }
