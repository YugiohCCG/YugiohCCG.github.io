...
public class LogCardHintNumberData : ILogEventData, IPooledData
{
	[CompilerGenerated]
	...
	[CalledBy(Type = typeof(LogManager), Member = "OnCardHintNumber", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(byte), typeof(ClientCard), typeof(int)}, ReturnType = typeof(void))]
	[CallerCount(Count = 1)]
	[CallsDeduplicatedMethods(Count = 1)]
	public LogCardHintNumberData() { }
