...
public class LogCardReposition : LogEntryContent
{
	[SerializeField]
	...
	[SerializeField]
	private Image Change; //Field offset: 0x38

	[CallerCount(Count = 36)]
	[CallsDeduplicatedMethods(Count = 1)]
	[DeduplicatedMethod]
	public LogCardReposition() { }

	[CallerCount(Count = 0)]
	[Calls(Type = typeof(LogManager), Member = "PositionChangeIconName", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(CardPosition), typeof(CardPosition)}, ReturnType = typeof(string))]
