...
public class LogCardRepositionData : ILogEventData, IPooledData
{
	[CompilerGenerated]
	...
	public CardPosition PrevPos; //Field offset: 0x50
	public CardPosition CurPos; //Field offset: 0x54
