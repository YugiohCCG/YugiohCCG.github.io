...
public class LogCardSummonedData : ILogEventData, IPooledData
{
	[CompilerGenerated]
	...
	public bool FlipSummon; //Field offset: 0x50
	...
	[CalledBy(Type = typeof(LogManager), Member = "OnCardSummoned", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(ClientCard), typeof(bool)}, ReturnType = typeof(void))]
	[CallerCount(Count = 1)]
	[CallsDeduplicatedMethods(Count = 1)]
	public LogCardSummonedData() { }
