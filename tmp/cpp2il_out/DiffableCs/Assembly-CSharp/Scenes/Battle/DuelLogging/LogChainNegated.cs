...
public class LogChainNegated : LogEntryContent
{
	[SerializeField]
	...
	[SerializeField]
	private LogCardEntry Negator; //Field offset: 0x30
	[SerializeField]
	private LogCardEntry Negated; //Field offset: 0x38
	[SerializeField]
	private Image NegatedIcon; //Field offset: 0x40

	[CallerCount(Count = 36)]
	[CallsDeduplicatedMethods(Count = 1)]
	[DeduplicatedMethod]
	public LogChainNegated() { }
