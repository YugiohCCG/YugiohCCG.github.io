...
public class AboutScreen : MonoBehaviour, IPointerClickHandler, IEventSystemHandler
{
	[CompilerGenerated]
	private struct <Create>d__9 : IAsyncStateMachine
	{
		...
		private TaskAwaiter<AboutScreen> <>u__2; //Field offset: 0x38
	...
	[CompilerGenerated]
	private struct <UpdateCredits>d__12 : IAsyncStateMachine
	{
		public int <>1__state; //Field offset: 0x0
		public AsyncVoidMethodBuilder <>t__builder; //Field offset: 0x8
		public AboutScreen <>4__this; //Field offset: 0x28
	...
	private static object AboutPrefab; //Field offset: 0x0
	private const string CREDITS_URL = "https://raw.githubusercontent.com/duelists-unite/omega-releases/main/CREDITS.md"; //Field offset: 0x0
	public static AboutScreen Instance; //Field offset: 0x8
	public TextMeshProUGUI Title; //Field offset: 0x20
	public TextMeshProUGUI About; //Field offset: 0x28
	public Button Close; //Field offset: 0x30
	public Button Donate; //Field offset: 0x38
	public Button DiscordButton; //Field offset: 0x40
	...
	[Calls(Type = typeof(AsyncVoidMethodBuilder), Member = "Create", ReturnType = typeof(AsyncVoidMethodBuilder))]
	[Calls(Type = typeof(AsyncVoidMethodBuilder), Member = "Start", MemberTypeParameters = new IL2CPP_TYPE_OBJECT[] {typeof(<UpdateCredits>d__12)}, MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(<UpdateCredits>d__12&)}, ReturnType = typeof(void))]
	[CallsDeduplicatedMethods(Count = 5)]
	[CallsUnknownMethods(Count = 5)]
	private void Start() { }

	[AsyncStateMachine(typeof(<UpdateCredits>d__12))]
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(AsyncVoidMethodBuilder), Member = "Create", ReturnType = typeof(AsyncVoidMethodBuilder))]
	[Calls(Type = typeof(AsyncVoidMethodBuilder), Member = "Start", MemberTypeParameters = new IL2CPP_TYPE_OBJECT[] {typeof(<UpdateCredits>d__12)}, MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(<UpdateCredits>d__12&)}, ReturnType = typeof(void))]
	[CallsUnknownMethods(Count = 2)]
