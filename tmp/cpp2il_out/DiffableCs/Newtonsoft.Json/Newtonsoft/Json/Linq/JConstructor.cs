...
public class JConstructor : JContainer
{
	...
	[CalledBy(Type = typeof(JConstructor), Member = ".ctor", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(string), typeof(Object[])}, ReturnType = typeof(void))]
	[CalledBy(Type = typeof(JConstructor), Member = ".ctor", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(string), typeof(object)}, ReturnType = typeof(void))]
	...
	[CalledBy(Type = typeof(JConstructor), Member = "Load", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(JsonReader)}, ReturnType = typeof(JConstructor))]
	...
	[CalledBy(Type = typeof(JConstructor), Member = "LoadAsync", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(JsonReader), typeof(CancellationToken)}, ReturnType = typeof(System.Threading.Tasks.Task`1<Newtonsoft.Json.Linq.JConstructor>))]
