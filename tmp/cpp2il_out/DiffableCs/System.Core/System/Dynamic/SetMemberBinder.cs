...
public abstract class SetMemberBinder : DynamicMetaObjectBinder
{
	...
	[CalledBy(Type = "Newtonsoft.Json.Utilities.NoThrowSetBinderMember", Member = ".ctor", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SetMemberBinder)}, ReturnType = typeof(void))]
	[CallerCount(Count = 1)]
