...
internal sealed class Block3 : BlockExpression
{
	...
	[CalledBy(Type = typeof(Expression), Member = "Block", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(Expression), typeof(Expression), typeof(Expression)}, ReturnType = typeof(BlockExpression))]
	[CallerCount(Count = 1)]
