...
{
	private static readonly decimal s_defaultValue; //Field offset: 0x0
	private Decimal[] _values; //Field offset: 0x50
	...
	[Calls(Type = typeof(Decimal), Member = "Compare", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(Decimal), typeof(Decimal)}, ReturnType = typeof(int))]
