...
{
	private Int16[] _values; //Field offset: 0x50
	...
	[Calls(Type = typeof(short), Member = "CompareTo", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(short)}, ReturnType = typeof(int))]
