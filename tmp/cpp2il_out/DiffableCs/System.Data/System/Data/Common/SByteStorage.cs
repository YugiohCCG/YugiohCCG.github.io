...
{
	private SByte[] _values; //Field offset: 0x50
	...
	[Calls(Type = typeof(sbyte), Member = "CompareTo", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(sbyte)}, ReturnType = typeof(int))]
