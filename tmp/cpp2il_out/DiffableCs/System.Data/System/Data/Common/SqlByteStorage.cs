...
{
	private SqlByte[] _values; //Field offset: 0x50
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(SqlByte), Member = "ToSqlDouble", ReturnType = typeof(SqlDouble))]
	[Calls(Type = typeof(Type), Member = "GetTypeFromHandle", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(RuntimeTypeHandle)}, ReturnType = typeof(Type))]
	...
	[Calls(Type = typeof(SqlByte), Member = "GreaterThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlByte), typeof(SqlByte)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlByte), Member = "LessThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlByte), typeof(SqlByte)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlInt64), Member = "ToSqlByte", ReturnType = typeof(SqlByte))]
	...
	[Calls(Type = typeof(SqlByte), Member = "ToSqlInt64", ReturnType = typeof(SqlInt64))]
