...
{
	private SqlBytes[] _values; //Field offset: 0x50
	...
	[Calls(Type = typeof(SqlBytes), Member = ".ctor", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlBinary)}, ReturnType = typeof(void))]
