...
{
	private SqlChars[] _values; //Field offset: 0x50
	...
	[Calls(Type = typeof(SqlChars), Member = ".ctor", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlString)}, ReturnType = typeof(void))]
