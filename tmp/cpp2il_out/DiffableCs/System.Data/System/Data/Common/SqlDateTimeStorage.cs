...
{
	private SqlDateTime[] _values; //Field offset: 0x50
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(SqlDateTime), Member = "GreaterThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlDateTime), typeof(SqlDateTime)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlDateTime), Member = "LessThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlDateTime), typeof(SqlDateTime)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(Type), Member = "GetTypeFromHandle", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(RuntimeTypeHandle)}, ReturnType = typeof(Type))]
