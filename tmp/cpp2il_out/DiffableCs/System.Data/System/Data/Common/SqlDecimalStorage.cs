...
{
	private SqlDecimal[] _values; //Field offset: 0x50
	...
	[Calls(Type = typeof(SqlDecimal), Member = "ToSqlDouble", ReturnType = typeof(SqlDouble))]
	...
	[Calls(Type = typeof(SqlDecimal), Member = "GreaterThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlDecimal), typeof(SqlDecimal)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlDecimal), Member = "LessThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlDecimal), typeof(SqlDecimal)}, ReturnType = typeof(SqlBoolean))]
