...
{
	private SqlDouble[] _values; //Field offset: 0x50
	...
	[Calls(Type = typeof(SqlDouble), Member = "LessThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlDouble), typeof(SqlDouble)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlDouble), Member = "GreaterThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlDouble), typeof(SqlDouble)}, ReturnType = typeof(SqlBoolean))]
