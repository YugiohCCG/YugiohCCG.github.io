...
{
	private SqlGuid[] _values; //Field offset: 0x50
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(SqlGuid), Member = "CompareTo", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlGuid)}, ReturnType = typeof(int))]
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(SqlConvert), Member = "ConvertToSqlGuid", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(object)}, ReturnType = typeof(SqlGuid))]
