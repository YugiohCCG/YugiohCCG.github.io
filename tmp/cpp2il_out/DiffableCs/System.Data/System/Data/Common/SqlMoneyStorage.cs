...
{
	private SqlMoney[] _values; //Field offset: 0x50
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(SqlMoney), Member = "ToSqlDouble", ReturnType = typeof(SqlDouble))]
	[Calls(Type = typeof(Type), Member = "GetTypeFromHandle", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(RuntimeTypeHandle)}, ReturnType = typeof(Type))]
	...
	[Calls(Type = typeof(SqlMoney), Member = "GreaterThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlMoney), typeof(SqlMoney)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlMoney), Member = "LessThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlMoney), typeof(SqlMoney)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlDecimal), Member = "ToSqlMoney", ReturnType = typeof(SqlMoney))]
	...
	[Calls(Type = typeof(SqlMoney), Member = "ToSqlDecimal", ReturnType = typeof(SqlDecimal))]
	...
	[Calls(Type = typeof(SqlDecimal), Member = "op_Implicit", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlMoney)}, ReturnType = typeof(SqlDecimal))]
