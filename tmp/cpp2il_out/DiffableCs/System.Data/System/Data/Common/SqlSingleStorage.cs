...
{
	private SqlSingle[] _values; //Field offset: 0x50
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(SqlSingle), Member = "GreaterThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlSingle), typeof(SqlSingle)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(Type), Member = "GetTypeFromHandle", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(RuntimeTypeHandle)}, ReturnType = typeof(Type))]
	...
	[Calls(Type = typeof(SqlSingle), Member = "LessThan", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlSingle), typeof(SqlSingle)}, ReturnType = typeof(SqlBoolean))]
	[Calls(Type = typeof(SqlDouble), Member = "ToSqlSingle", ReturnType = typeof(SqlSingle))]
	...
	[Calls(Type = typeof(SqlSingle), Member = "ToSqlDouble", ReturnType = typeof(SqlDouble))]
	...
	[Calls(Type = typeof(SqlSingle), Member = "op_Addition", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(SqlSingle), typeof(SqlSingle)}, ReturnType = typeof(SqlSingle))]
