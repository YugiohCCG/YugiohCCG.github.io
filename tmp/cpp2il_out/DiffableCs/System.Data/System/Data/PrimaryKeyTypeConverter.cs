...
internal sealed class PrimaryKeyTypeConverter : ReferenceConverter
{
	...
	[Calls(Type = typeof(ReferenceConverter), Member = "ConvertTo", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(ITypeDescriptorContext), typeof(CultureInfo), typeof(object), typeof(Type)}, ReturnType = typeof(object))]
