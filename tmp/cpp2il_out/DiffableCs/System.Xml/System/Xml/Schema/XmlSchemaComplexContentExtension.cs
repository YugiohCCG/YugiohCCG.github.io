...
public class XmlSchemaComplexContentExtension : XmlSchemaContent
{
	...
	[CalledBy(Type = typeof(XsdBuilder), Member = "InitComplexContentExtension", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(XsdBuilder), typeof(string)}, ReturnType = typeof(void))]
	[CallerCount(Count = 1)]
