...
public struct NativeHashMap : INativeDisposable, IDisposable, IEnumerable<KVPair`2<TKey, TValue>>, IEnumerable
{
	...
	[CalledBy(Type = "UnityEngine.Rendering.IndirectBufferContextStorage", Member = "Init", ReturnType = typeof(void))]
	[CallerCount(Count = 1)]
	...
	[CalledBy(Type = "UnityEngine.Rendering.IndirectBufferContextStorage", Member = "TryAllocateContext", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(int)}, ReturnType = typeof(int))]
	[CallerCount(Count = 1)]
	...
	[CalledBy(Type = "UnityEngine.Rendering.IndirectBufferContextStorage", Member = "Dispose", ReturnType = typeof(void))]
	[CallerCount(Count = 1)]
	...
	[CalledBy(Type = "UnityEngine.Rendering.IndirectBufferContextStorage", Member = "TryGetContextIndex", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(int)}, ReturnType = typeof(int))]
	[CallerCount(Count = 1)]
	[Calls(Type = typeof(HashMapHelper`1), Member = "TryGetValue", MemberTypeParameters = new IL2CPP_TYPE_OBJECT[] {"TValue"}, MemberParameters = new IL2CPP_TYPE_OBJECT[] {"TKey", "TValue&"}, ReturnType = typeof(bool))]
	[CallsUnknownMethods(Count = 1)]
	[DeduplicatedMethod]
