...
public class HoldInteraction : IInputInteraction
{
	...
	[CallerCount(Count = 0)]
	[Calls(Type = typeof(HoldInteraction), Member = "get_pressPointOrDefault", ReturnType = typeof(float))]
	...
	[Calls(Type = typeof(HoldInteraction), Member = "get_durationOrDefault", ReturnType = typeof(float))]
