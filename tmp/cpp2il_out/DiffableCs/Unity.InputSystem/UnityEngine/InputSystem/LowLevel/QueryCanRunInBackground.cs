...
public struct QueryCanRunInBackground : IInputDeviceCommandInfo
{
	...
	[CalledBy(Type = typeof(InputDevice), Member = "get_canRunInBackground", ReturnType = typeof(bool))]
	[CalledBy(Type = typeof(InputDevice), Member = "get_canDeviceRunInBackground", ReturnType = typeof(bool))]
	[CallerCount(Count = 2)]
	[Calls(Type = typeof(FourCC), Member = ".ctor", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(char), typeof(char), typeof(char), typeof(char)}, ReturnType = typeof(void))]
