...
public class Tuple : IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal, ITuple
{
	...
	[CalledBy(Type = "Mono.Net.Security.MonoTlsProviderFactory", Member = "InitializeProviderRegistration", ReturnType = typeof(void))]
	[CalledBy(Type = "Mono.Net.Security.MonoTlsProviderFactory", Member = "PopulateUnityProviders", ReturnType = typeof(void))]
	[CalledBy(Type = "Mono.Net.Security.MonoTlsProviderFactory", Member = "PopulateProviders", ReturnType = typeof(void))]
	[CallerCount(Count = 4)]
