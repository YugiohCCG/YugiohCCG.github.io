...
public class Tuple : IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal, ITuple
{
	...
	[CalledBy(Type = "System.Data.Common.DataStorage", Member = "InspectTypeForInterfaces", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(Type)}, ReturnType = "System.Tuple`4<Boolean, Boolean, Boolean, Boolean>")]
	[CallerCount(Count = 1)]
