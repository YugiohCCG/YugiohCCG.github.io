...
public sealed class EmailAddressParsedResult : ParsedResult
{
	...
	private string <EmailAddress>k__BackingField; //Field offset: 0x20
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private string <Subject>k__BackingField; //Field offset: 0x28
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private string <Body>k__BackingField; //Field offset: 0x30
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private string <MailtoURI>k__BackingField; //Field offset: 0x38
	...
	public private string EmailAddress
	{
	...
	public private string MailtoURI
	{
	...
	[CalledBy(Type = typeof(SMTPResultParser), Member = "parse", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(Result)}, ReturnType = typeof(ParsedResult))]
	[CallerCount(Count = 4)]
	...
	[CompilerGenerated]
	[DeduplicatedMethod]
	private void set_EmailAddress(string value) { }

	[CallerCount(Count = 3)]
	[CallsUnknownMethods(Count = 1)]
	[CompilerGenerated]
	[DeduplicatedMethod]
	private void set_MailtoURI(string value) { }
