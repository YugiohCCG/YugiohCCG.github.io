...
public sealed class TelParsedResult : ParsedResult
{
	...
	private string <Number>k__BackingField; //Field offset: 0x20
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private string <TelURI>k__BackingField; //Field offset: 0x28
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private string <Title>k__BackingField; //Field offset: 0x30

	public private string Number
	{
