...
{
	private const int CODE_WIDTH = 95; //Field offset: 0x0
	...
	[Calls(Type = typeof(UPCEANReader), Member = "checkStandardUPCEANChecksum", MemberParameters = new IL2CPP_TYPE_OBJECT[] {typeof(string)}, ReturnType = typeof(bool))]
